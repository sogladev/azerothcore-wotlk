...
\****************************************************************************/
    template <> AC_API_EXPORT EnumText EnumUtils<CreatureAI::EvadeReason>::ToString(CreatureAI::EvadeReason value)
    {
        switch (value)
        {
    ...
    template <> AC_API_EXPORT std::size_t EnumUtils<CreatureAI::EvadeReason>::Count()
    {
        return 4;
    }

    template <> AC_API_EXPORT CreatureAI::EvadeReason EnumUtils<CreatureAI::EvadeReason>::FromIndex(std::size_t index)
    {
        switch (index)
        {
            case 0:
    ...
    template <> AC_API_EXPORT std::size_t EnumUtils<CreatureAI::EvadeReason>::ToIndex(CreatureAI::EvadeReason value)
    {
        switch (value)
        {
            case CreatureAI::EVADE_REASON_NO_HOSTILES:
