...
{
    static constexpr float BOUNDARY_STEP = 2.0f;
    static constexpr int32 BOUNDARY_LIMIT = 5000;
    static constexpr uint32 BOUNDARY_VISUALIZE_CREATURE = 15425;
    static constexpr float BOUNDARY_VISUALIZE_CREATURE_SCALE = 0.25f;
    static Position const BOUNDARY_DIRECTIONS[4] = {
        {BOUNDARY_STEP,  0,              0},
        {-BOUNDARY_STEP, 0,              0},
        {0,              BOUNDARY_STEP,  0},
        {0,              -BOUNDARY_STEP, 0},
    ...
    auto spawnVisualizationCreature = [owner, duration](Position const& pos)
    {
    ...
    struct PositionHash
    {
        ...
        {
            return std::hash<float>()(pos.m_positionX) ^ std::hash<float>()(pos.m_positionY) ^
                   std::hash<float>()(pos.m_positionZ);
        }
    };
    ...
    while (!queue.empty())
    {
        ...
        for (auto const& direction : BOUNDARY_DIRECTIONS)
        {
