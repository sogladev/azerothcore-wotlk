...
\********************************************************/
    template <> AC_API_EXPORT EnumText EnumUtils<UnitFlags>::ToString(UnitFlags value)
    {
        switch (value)
        {
            case UNIT_FLAG_NONE:
            ...
            case UNIT_FLAG_NON_ATTACKABLE:
                return {"UNIT_FLAG_NON_ATTACKABLE", "UNIT_FLAG_NON_ATTACKABLE", "not attackable"};
            ...
            case UNIT_FLAG_IMMUNE_TO_PC:
                return {"UNIT_FLAG_IMMUNE_TO_PC",
                    ...
                    "disables combat/assistance with PlayerCharacters (PC) - see Unit::_IsValidAttackTarget, Unit::_IsValidAssistTarget"};
            case UNIT_FLAG_IMMUNE_TO_NPC:
                return {"UNIT_FLAG_IMMUNE_TO_NPC",
                    "UNIT_FLAG_IMMUNE_TO_NPC",
                    "disables combat/assistance with NonPlayerCharacters (NPC) - see Unit::_IsValidAttackTarget, Unit::_IsValidAssistTarget"};
            case UNIT_FLAG_LOOTING:
                return {"UNIT_FLAG_LOOTING", "UNIT_FLAG_LOOTING", "loot animation"};
            case UNIT_FLAG_PET_IN_COMBAT:
                return {"UNIT_FLAG_PET_IN_COMBAT", "UNIT_FLAG_PET_IN_COMBAT", "in combat?, 2.0.8"};
            case UNIT_FLAG_PVP:
            ...
            case UNIT_FLAG_SWIMMING:
                return {"UNIT_FLAG_SWIMMING", "UNIT_FLAG_SWIMMING", "shows swim animation in water"};
    ...
    template <> AC_API_EXPORT std::size_t EnumUtils<UnitFlags>::Count()
    {
        return 33;
    }

    template <> AC_API_EXPORT UnitFlags EnumUtils<UnitFlags>::FromIndex(std::size_t index)
    {
        switch (index)
        {
            case 0:
    ...
    template <> AC_API_EXPORT std::size_t EnumUtils<UnitFlags>::ToIndex(UnitFlags value)
    {
        switch (value)
        {
            case UNIT_FLAG_NONE:
...
\*******************************************************/
    template <> AC_API_EXPORT EnumText EnumUtils<NPCFlags>::ToString(NPCFlags value)
    {
        switch (value)
        {
            ...
            case UNIT_NPC_FLAG_QUESTGIVER:
                return {"UNIT_NPC_FLAG_QUESTGIVER", "is quest giver", "guessed, probably ok"};
            ...
            case UNIT_NPC_FLAG_TRAINER_PROFESSION:
                return {"UNIT_NPC_FLAG_TRAINER_PROFESSION", "is profession trainer", "100%"};
            case UNIT_NPC_FLAG_VENDOR:
                return {"UNIT_NPC_FLAG_VENDOR", "is vendor (generic)", "100%"};
            case UNIT_NPC_FLAG_VENDOR_AMMO:
                return {"UNIT_NPC_FLAG_VENDOR_AMMO", "is vendor (ammo)", "100%, general goods vendor"};
            ...
            case UNIT_NPC_FLAG_TABARDDESIGNER:
                return {"UNIT_NPC_FLAG_TABARDDESIGNER", "is guild tabard designer", "100%"};
            ...
            case UNIT_NPC_FLAG_GUILD_BANKER:
                return {"UNIT_NPC_FLAG_GUILD_BANKER", "is guild banker", "cause client to send 997 opcode"};
    ...
    template <> AC_API_EXPORT std::size_t EnumUtils<NPCFlags>::Count()
    {
        return 28;
    }

    template <> AC_API_EXPORT NPCFlags EnumUtils<NPCFlags>::FromIndex(std::size_t index)
    {
        switch (index)
        {
            case 0:
    ...
    template <> AC_API_EXPORT std::size_t EnumUtils<NPCFlags>::ToIndex(NPCFlags value)
    {
        switch (value)
        {
            case UNIT_NPC_FLAG_GOSSIP:
