...
void ScriptMgr::OnGetSlotByType(uint32 const type, uint8& slot)
{
...
void ScriptMgr::OnArenaTypeIDToQueueID(BattlegroundTypeId const bgTypeId, uint8 const arenaType, uint32& queueTypeID)
{
...
void ScriptMgr::OnArenaQueueIdToArenaType(BattlegroundQueueTypeId const bgQueueTypeId, uint8& ArenaType)
{
    CALL_ENABLED_HOOKS(ArenaTeamScript,
...
void ScriptMgr::OnSetArenaMaxPlayersPerTeam(uint8 const arenaType, uint32& maxPlayerPerTeam)
{
    CALL_ENABLED_HOOKS(ArenaTeamScript,
