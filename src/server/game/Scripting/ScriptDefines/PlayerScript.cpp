...
void ScriptMgr::OnGetSpellQueueWindow(const Player* player, uint32& window)
{
    CALL_ENABLED_HOOKS(PlayerScript, PLAYERHOOK_ON_GET_SPELLQUEUE_WINDOW, script->OnGetSpellQueueWindow(player, window));
}
