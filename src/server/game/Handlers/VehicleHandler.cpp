...
void WorldSession::HandleEjectPassenger(WorldPacket& data)
{
    ...
    if (guid.IsPlayer())
    {
        ...
        {
            LOG_ERROR("network.opcode",
                "Player {} tried to eject player {} from vehicle, but the latter was not found in world!",
                GetPlayer()->GetGUID().ToString(),
                guid.ToString());
            return;
        }
        ...
        {
            LOG_ERROR("network.opcode",
                "Player {} tried to eject player {}, but they are not in the same vehicle",
                GetPlayer()->GetGUID().ToString(),
                guid.ToString());
            return;
        }
        ...
        if (seat->IsEjectable())
            ...
            LOG_ERROR("network.opcode",
                "Player {} attempted to eject player {} from non-ejectable seat.",
                GetPlayer()->GetGUID().ToString(),
                guid.ToString());
    }
    else if (guid.IsCreature())
    {
        ...
        {
            LOG_ERROR("network.opcode",
                "Player {} tried to eject creature guid {} from vehicle, but the latter was not found in world!",
                GetPlayer()->GetGUID().ToString(),
                guid.ToString());
            return;
        }
        ...
        {
            LOG_ERROR("network.opcode",
                "Player {} tried to eject unit {}, but they are not in the same vehicle",
                GetPlayer()->GetGUID().ToString(),
                guid.ToString());
            return;
        }
        ...
        if (seat->IsEjectable())
        {
            ...
            LOG_ERROR("network.opcode",
                "Player {} attempted to eject creature {} from non-ejectable seat.",
                GetPlayer()->GetGUID().ToString(),
                guid.ToString());
    }
    else
