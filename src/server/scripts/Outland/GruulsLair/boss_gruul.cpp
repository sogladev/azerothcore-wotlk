...
class spell_gruul_ground_slam : public SpellScript
{
    ...
    void Register() override
    {
        ...
        OnEffectHitTarget +=
            SpellEffectFn(spell_gruul_ground_slam::HandleScriptEffect, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_tractor_beam_creator : public SpellScript
{
    ...
    void HandleScriptEffect(SpellEffIndex /*effIndex*/)
    {
        if (Unit* caster = GetCaster())
        {
            std::vector<uint32> tractorBeamSummons = {SPELL_SUMMON_TRACTOR_BEAM_1,
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_tractor_beam_creator::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_gruul_ground_slam_trigger : public AuraScript
{
    ...
    void Register() override
    {
        AfterEffectRemove += AuraEffectRemoveFn(spell_gruul_ground_slam_trigger::OnApply,
            EFFECT_0,
...
class spell_gruul_shatter : public SpellScript
{
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_gruul_shatter::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
