    ...
    struct boss_reliquary_of_soulsAI : public BossAI
    {
        ...
        void MoveInLineOfSight(Unit* who) override
        {
            if (!who || me->getStandState() != UNIT_STAND_STATE_SLEEP || !who->IsPlayer() ||
                me->GetDistance2d(who) > 90.0f || who->ToPlayer()->IsGameMaster())
                return;
        ...
        {
            me->SetStandState(UNIT_STAND_STATE_STAND);
            me->m_Events.AddEventAtOffset([&] { me->SetStandState(UNIT_STAND_STATE_STAND); }, 1s);
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            me->m_Events.AddEventAtOffset([&] { summons.DoAction(ACTION_ENGAGE_ESSENCE); }, 4s);
        }
    ...
    struct boss_essence_of_sufferingAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            ...
            me->m_Events.AddEvent(
                new SuckBackEvent(*me, ACTION_ESSENCE_OF_SUFFERING), me->m_Events.CalculateTime(1500));
            me->SetTarget();
        ...
        void KilledUnit(Unit* /*victim*/) override
        {
            ...
            {
                Talk(SUFF_SAY_SLAY);
                me->m_Events.AddEventAtOffset([&] { _recentlySpoken = false; }, 6s);
            }
        }
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
                ...
                [&]
            {
                ...
                me->m_Events.AddEventAtOffset([&] { Talk(SUFF_EMOTE_ENRAGE); }, 3s);
            },
                45s);

            ScheduleTimedEvent(
                25s, [&] { me->CastCustomSpell(SPELL_SOUL_DRAIN, SPELLVALUE_MAX_TARGETS, 3, me, false); }, 30s);
        }
...
public:
    ...
    struct boss_essence_of_desireAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            ScheduleTimedEvent(13s, [&] { DoCastSelf(SPELL_RUNE_SHIELD); }, 15s);
        }
...
public:
    ...
    struct boss_essence_of_angerAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            ScheduleTimedEvent(10s, [&] { DoCastVictim(SPELL_SOUL_SCREAM); }, 10s);
...
class spell_reliquary_of_souls_aura_of_suffering_aura : public AuraScript
{
    ...
    {
        OnEffectApply += AuraEffectApplyFn(spell_reliquary_of_souls_aura_of_suffering_aura::HandleEffectApply,
            EFFECT_0,
            SPELL_AURA_MOD_HEALING_PCT,
            AURA_EFFECT_HANDLE_REAL);
        OnEffectRemove += AuraEffectRemoveFn(spell_reliquary_of_souls_aura_of_suffering_aura::HandleEffectRemove,
            EFFECT_0,
            SPELL_AURA_MOD_HEALING_PCT,
            AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_reliquary_of_souls_fixate : public SpellScript
{
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_reliquary_of_souls_fixate::FilterTargets, EFFECT_ALL, TARGET_UNIT_SRC_AREA_ENEMY);
    }
};
...
class spell_reliquary_of_souls_fixate_aura : public AuraScript
{
    ...
    void Register() override
    {
        OnEffectRemove += AuraEffectRemoveFn(spell_reliquary_of_souls_fixate_aura::HandleEffectRemove,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_reliquary_of_souls_aura_of_desire_aura : public AuraScript
{
    ...
    void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& eventInfo)
    {
        ...
        eventInfo.GetActionTarget()->CastCustomSpell(SPELL_AURA_OF_DESIRE_DAMAGE,
    ...
    void Register() override
    {
        ...
        OnEffectProc += AuraEffectProcFn(
            spell_reliquary_of_souls_aura_of_desire_aura::HandleProc, EFFECT_0, SPELL_AURA_MOD_HEALING_PCT);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_reliquary_of_souls_aura_of_desire_aura::CalculateAmount,
            EFFECT_1,
            SPELL_AURA_MOD_INCREASE_ENERGY_PERCENT);
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_reliquary_of_souls_aura_of_desire_aura::Update, EFFECT_2, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_reliquary_of_souls_aura_of_anger_aura : public AuraScript
{
    ...
    void Register() override
    {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_reliquary_of_souls_aura_of_anger_aura::CalculateAmount, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_reliquary_of_souls_aura_of_anger_aura::CalculateAmount, EFFECT_1, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE);
        OnEffectPeriodic += AuraEffectPeriodicFn(
            spell_reliquary_of_souls_aura_of_anger_aura::Update, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE);
    }
};
...
class spell_reliquary_of_souls_spite_aura : public AuraScript
{
    ...
    void Register() override
    {
        AfterEffectRemove += AuraEffectRemoveFn(spell_reliquary_of_souls_spite_aura::HandleEffectRemove,
            EFFECT_0,
