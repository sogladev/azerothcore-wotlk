...
struct boss_lady_vashj : public BossAI
{
    ...
    void Reset() override
    {
            ...
            [&]
        {
            ...
            me->GetMotionMaster()->MovePoint(POINT_HOME,
...
class spell_lady_vashj_magic_barrier : public AuraScript
{
    ...
    {
        AfterEffectRemove += AuraEffectRemoveFn(spell_lady_vashj_magic_barrier::HandleEffectRemove,
            EFFECT_0,
...
class spell_lady_vashj_remove_tainted_cores : public SpellScript
{
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_lady_vashj_remove_tainted_cores::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_lady_vashj_summon_sporebat : public SpellScript
{
    ...
    void HandleScriptEffect(SpellEffIndex effIndex)
    {
        ...
        GetCaster()->CastSpell(GetCaster(),
            RAND(SPELL_SUMMON_SPOREBAT1, SPELL_SUMMON_SPOREBAT2, SPELL_SUMMON_SPOREBAT3, SPELL_SUMMON_SPOREBAT4),
            true);
    }
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_lady_vashj_summon_sporebat::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_lady_vashj_spore_drop_effect : public SpellScript
{
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_lady_vashj_spore_drop_effect::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_lady_vashj_summons : public SpellScript
{
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo(
            {SPELL_SUMMON_WAVE_A_MOB, SPELL_SUMMON_WAVE_B_MOB, SPELL_SUMMON_WAVE_C_MOB, SPELL_SUMMON_WAVE_D_MOB});
    }
    ...
    void FilterTargets(std::list<WorldObject*>& targets)
    {
        ...
        bool top =
            GetSpellInfo()->Id == SPELL_SUMMON_COILFANG_ELITE || GetSpellInfo()->Id == SPELL_SUMMON_COILFANG_STRIDER;
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_lady_vashj_summons::FilterTargets, EFFECT_ALL, TARGET_UNIT_SRC_AREA_ENTRY);
