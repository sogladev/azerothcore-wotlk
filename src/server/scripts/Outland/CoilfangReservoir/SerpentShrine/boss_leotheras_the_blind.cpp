...
struct boss_leotheras_the_blind : public BossAI
{
    ...
    void Reset() override
    {
            ...
            [&]
        {
            ...
            scheduler.Schedule(4s, [this](TaskContext) { DoCastSelf(SPELL_SUMMON_SHADOW_OF_LEOTHERAS); })
                .Schedule(6s,
                    [this](TaskContext)
            {
                DoResetThreatList();
...
class spell_leotheras_whirlwind : public SpellScript
{
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_leotheras_whirlwind::HandleScriptEffect, EFFECT_2, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_leotheras_insidious_whisper : public SpellScript
{
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_leotheras_insidious_whisper::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
    }
};
...
class spell_leotheras_insidious_whisper_aura : public AuraScript
{
    ...
    void Register() override
    {
        AfterEffectApply += AuraEffectApplyFn(spell_leotheras_insidious_whisper_aura::HandleEffectApply,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
        AfterEffectRemove += AuraEffectRemoveFn(spell_leotheras_insidious_whisper_aura::HandleEffectRemove,
            EFFECT_0,
            SPELL_AURA_DUMMY,
            AURA_EFFECT_HANDLE_REAL);
    }
...
class spell_leotheras_demon_link : public AuraScript
{
    ...
    {
        OnEffectPeriodic +=
            AuraEffectPeriodicFn(spell_leotheras_demon_link::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
};
...
class spell_leotheras_clear_consuming_madness : public SpellScript
{
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_leotheras_clear_consuming_madness::HandleScriptEffect, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
