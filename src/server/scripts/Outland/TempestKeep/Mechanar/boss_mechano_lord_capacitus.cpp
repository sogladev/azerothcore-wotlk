...
struct boss_mechano_lord_capacitus : public BossAI
{
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        }).Schedule(3min, [this](TaskContext /*context*/) { DoCastSelf(SPELL_BERSERK, true); });
...
class spell_capacitus_polarity_charge : public SpellScript
{
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_capacitus_polarity_charge::HandleDamage, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_capacitus_polarity_charge::HandleTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
    }
};
...
class spell_capacitus_polarity_charge_aura : public AuraScript
{
    ...
    void Register() override
    {
        AfterEffectRemove += AuraEffectRemoveFn(spell_capacitus_polarity_charge_aura::HandleAfterRemove,
            EFFECT_1,
