...
public:
    ...
    struct boss_doomlordkazzakAI : public ScriptedAI
    {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            ...
            {
                if (Unit* target =
                        SelectTarget(SelectTargetMethod::Random, 0, PowerUsersSelector(me, POWER_MANA, 100.0f, true)))
                {
...
class spell_mark_of_kazzak_aura : public AuraScript
{
    ...
    void Register() override
    {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_mark_of_kazzak_aura::CalculateAmount, EFFECT_0, SPELL_AURA_PERIODIC_MANA_LEECH);
        OnEffectPeriodic +=
            AuraEffectPeriodicFn(spell_mark_of_kazzak_aura::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_MANA_LEECH);
    }
};
