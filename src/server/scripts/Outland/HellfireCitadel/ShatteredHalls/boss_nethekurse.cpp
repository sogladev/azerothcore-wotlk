    ...
    void SetData(uint32 data, uint32 value) override
    {
        ...
        else if (value == SETDATA_PEON_DEATH && PeonKilledCount <= 4)
        {
                ...
                [this](TaskContext /*context*/)
            {
                ...
                scheduler.Schedule(
                    1s, GROUP_RP, [this](TaskContext /*context*/) { me->GetMotionMaster()->Initialize(); });
...
class spell_tsh_shadow_bolt : public SpellScript
{
    ...
    void Register() override
    {
        OnObjectTargetSelect +=
            SpellObjectTargetSelectFn(spell_tsh_shadow_bolt::SelectRandomPlayer, EFFECT_0, TARGET_UNIT_TARGET_ENEMY);
    }
};
