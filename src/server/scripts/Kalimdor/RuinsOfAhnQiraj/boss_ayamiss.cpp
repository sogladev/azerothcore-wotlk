...
struct npc_hive_zara_swarmer : public ScriptedAI
{
    ...
    void PathEndReached(uint32 /*pathId*/) override
    {
        ...
        me->m_Events.AddEventAtOffset([this]() { DoCastSelf(SPELL_HIVEZARA_SWARMER_START_LOOP); }, 1s);
    }
};
...
class spell_ayamiss_swarmer_teleport_trigger : public SpellScript
{
    ...
    void HandleScript(SpellEffIndex /*effIndex*/)
    {
        ...
        caster->m_Events.AddEventAtOffset(
            [caster, pathId]() { caster->GetMotionMaster()->MovePath(pathId, false); }, 1s);
    }

    void Register() override
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_ayamiss_swarmer_teleport_trigger::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
class spell_ayamiss_swarmer_start_loop : public SpellScript
{
    ...
    void HandleScript(SpellEffIndex /*effIndex*/)
    {
        GetCaster()->GetAI()->DoCastAOE(
            RAND(SPELL_HZ_SWARMER_LOOP_1, SPELL_HZ_SWARMER_LOOP_2, SPELL_HZ_SWARMER_LOOP_3));
    }

    void Register() override
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_ayamiss_swarmer_start_loop::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
...
void AddSC_boss_ayamiss()
{
    ...
    RegisterSpellScriptWithArgs(
        spell_gen_ayamiss_swarmer_loop, "spell_gen_ayamiss_swarmer_loop_1", (NPC_HIVEZARA_SWARMER + 5) * 10);
    RegisterSpellScriptWithArgs(
        spell_gen_ayamiss_swarmer_loop, "spell_gen_ayamiss_swarmer_loop_2", (NPC_HIVEZARA_SWARMER + 6) * 10);
    RegisterSpellScriptWithArgs(
        spell_gen_ayamiss_swarmer_loop, "spell_gen_ayamiss_swarmer_loop_3", (NPC_HIVEZARA_SWARMER + 7) * 10);
}
