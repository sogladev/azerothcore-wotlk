...
struct npc_anubisath_guardian : public ScriptedAI
{
    ...
    void JustEngagedWith(Unit* /*who*/) override
    {
        ...
        _scheduler.Schedule(10s,
            [this, spell](TaskContext context)
        {
...
class spell_crystal_weakness : public SpellScript
{
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_crystal_weakness::FilterTargets, EFFECT_ALL, TARGET_UNIT_SRC_AREA_ENTRY);
    }
};
...
class spell_aq_shadow_storm : public SpellScript
{
    ...
    void FilterTargets(std::list<WorldObject*>& targets)
    {
        ...
        targets.remove_if([caster](WorldObject const* obj) { return caster->GetExactDist2d(obj) < 25.0f; });
    }
