...
public:
    ...
    struct npc_thrall_old_hillsbradAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 waypointId) override
        {
            switch (waypointId)
            {
                ...
                case 10:
                    ...
                    break;
                case 18:
                    if (Creature* warden = me->SummonCreature(NPC_DURNHOLDE_WARDEN,
                            2149.4634f,
                            104.97559f,
                            73.632385f,
                            1.9065f,
                    ...
                    if (Creature* veteran = me->SummonCreature(NPC_DURNHOLDE_VETERAN,
                            2147.3281f,
                            106.72353f,
                            74.34447f,
                            1.6904f,
                    ...
                    if (Creature* mage = me->SummonCreature(NPC_DURNHOLDE_MAGE,
                            2147.624f,
                            104.61046f,
                            73.909294f,
                            1.6186f,
                ...
                case 59:
                    ...
                    if (Creature* mount = me->SummonCreature(
                            NPC_SKARLOC_MOUNT, 2488.64f, 625.77f, 58.26f, 4.71f, TEMPSUMMON_TIMED_DESPAWN, 7000))
                    {
        ...
        {
            if (summon->GetEntry() == NPC_INFINITE_SLAYER || summon->GetEntry() == NPC_INFINITE_SABOTEUR ||
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_DRESSING_TALK:
                    ...
                    Talk(SAY_GO_ARMORED);
                    if (Creature* sentry = me->SummonCreature(NPC_DURNHOLDE_SENTRY,
                            2185.916f,
                            140.38835f,
                            88.299866f,
                            5.9238f,
                ...
                case EVENT_SUMMON_GUARDS:
                    ...
                    me->SummonCreature(NPC_TM_LOOKOUT,
                        ...
                        TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        30 * IN_MILLISECONDS);
                    if (Creature* guardsman = me->SummonCreature(NPC_TM_GUARDSMAN,
                            2500.0908f,
                            699.9389f,
                            55.629555f,
                            4.2935f,
                ...
                case EVENT_SUMMON_CHRONO:
                    if (Creature* epoch = me->SummonCreature(
                            NPC_EPOCH_HUNTER, 2640.49f, 696.15f, 64.31f, 4.51f, TEMPSUMMON_MANUAL_DESPAWN))
                    {
                ...
                case EVENT_SUMMON_INFINITES:
                    ...
                    me->SummonCreature(
                        NPC_EPOCH_GUARDSMAN, 2629.46f, 704.76f, 56.286f, 4.98f, TEMPSUMMON_MANUAL_DESPAWN);
                    me->SummonCreature(
                        NPC_EPOCH_PROTECTOR, 2640.14f, 709.44f, 56.135f, 4.70f, TEMPSUMMON_MANUAL_DESPAWN);
                    summons.DoAction(ACTION_SET_IMMUNE_FLAG);
                ...
                case EVENT_CHECK_WAVE_1:
                    ...
                    {
                        me->SummonCreature(
                            NPC_INFINITE_SABOTEUR, 2599.57f, 683.72f, 55.975f, 0.05f, TEMPSUMMON_MANUAL_DESPAWN);
                        me->SummonCreature(
                            NPC_INFINITE_SLAYER, 2599.57f, 677.0f, 55.975f, 0.05f, TEMPSUMMON_MANUAL_DESPAWN);
                        me->SummonCreature(
                            NPC_INFINITE_DEFILER, 2592.57f, 680.0f, 55.975f, 0.05f, TEMPSUMMON_MANUAL_DESPAWN);
                        summons.DoAction(ACTION_START_COMBAT);
                ...
                case EVENT_CHECK_WAVE_2:
                    ...
                    {
                        me->SummonCreature(
                            NPC_INFINITE_SLAYER, 2642.62f, 701.43f, 55.965f, 4.46f, TEMPSUMMON_MANUAL_DESPAWN);
                        me->SummonCreature(
                            NPC_INFINITE_SLAYER, 2638.62f, 701.43f, 55.965f, 4.46f, TEMPSUMMON_MANUAL_DESPAWN);
                        me->SummonCreature(
                            NPC_INFINITE_SABOTEUR, 2638.62f, 705.43f, 55.965f, 4.46f, TEMPSUMMON_MANUAL_DESPAWN);
                        me->SummonCreature(
                            NPC_INFINITE_DEFILER, 2642.62f, 705.43f, 55.965f, 4.46f, TEMPSUMMON_MANUAL_DESPAWN);
                        summons.DoAction(ACTION_START_COMBAT);
                ...
                case EVENT_SUMMON_EROZION:
                    if (Creature* erozion = me->SummonCreature(
                            NPC_EROZION, 2646.31f, 680.01f, 55.36f, 3.76f, TEMPSUMMON_MANUAL_DESPAWN))
        ...
        void ReorderInstance(uint32 data)
        {
            ...
            switch (data)
            {
                ...
                case ENCOUNTER_PROGRESS_AMBUSHES_1:
                    ...
                    break;
                case ENCOUNTER_PROGRESS_SKARLOC_KILLED:
                    if (Creature* mount = me->SummonCreature(NPC_SKARLOC_MOUNT,
                            2049.12f,
                            252.31f,
                            62.855f,
                            me->GetOrientation(),
