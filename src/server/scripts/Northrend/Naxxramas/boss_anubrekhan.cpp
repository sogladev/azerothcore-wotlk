...
public:
    ...
    struct boss_anubrekhanAI : public BossAI
    {
        ...
        void SummonCryptGuards()
        {
            ...
            {
                me->SummonCreature(
                    NPC_CRYPT_GUARD, 3299.732f, -3502.489f, 287.077f, 2.378f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 60000);
                me->SummonCreature(
                    NPC_CRYPT_GUARD, 3299.086f, -3450.929f, 287.077f, 3.999f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 60000);
            }
        }
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            ScheduleTimedEvent(15s, [&] { DoCastRandomTarget(RAID_MODE(SPELL_IMPALE_10, SPELL_IMPALE_25)); }, 20s);

            ScheduleTimedEvent(70s,
                2min,
                [&]
            {
                Talk(EMOTE_LOCUST);
