...
class spell_putricide_mutated_transformation : public SpellScript
{
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({ SPELL_ABOMINATION_VEHICLE_POWER_DRAIN, SPELL_MUTATED_TRANSFORMATION_DAMAGE, SPELL_MUTATED_TRANSFORMATION_NAME, SPELL_RIDE_HARDCODED });
    }
