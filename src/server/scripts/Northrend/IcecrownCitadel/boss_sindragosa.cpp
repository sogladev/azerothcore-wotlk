...
class spell_sindragosa_ice_tomb : public SpellScript
{
    PrepareSpellScript(spell_sindragosa_ice_tomb);
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_sindragosa_ice_tomb::FilterTargets, EFFECT_1, TARGET_UNIT_DEST_AREA_ENEMY);
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_sindragosa_ice_tomb::FilterTargetsSubseq, EFFECT_2, TARGET_UNIT_DEST_AREA_ENEMY);
    }
};

class spell_sindragosa_ice_tomb_aura : public AuraScript
{
    PrepareAuraScript(spell_sindragosa_ice_tomb_aura);
    ...
    void Register() override
    {
        OnEffectPeriodic += AuraEffectPeriodicFn(spell_sindragosa_ice_tomb_aura::PeriodicTick, EFFECT_2, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        AfterEffectRemove += AuraEffectRemoveFn(spell_sindragosa_ice_tomb_aura::ExtraRemoveEffect, EFFECT_1, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
        AfterEffectApply += AuraEffectApplyFn(spell_sindragosa_ice_tomb_aura::AfterApply, EFFECT_1, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
    }
};
...
class spell_sindragosa_soul_preservation_aura : public AuraScript
{
    ...
    {
        return ValidateSpellInfo({ 72466 });
    }
...
class spell_sindragosa_frost_breath : public SpellScript
{
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({ SPELL_FROST_IMBUED_BLADE, SPELL_FROST_INFUSION });
    }
...
void AddSC_boss_sindragosa()
{
    ...
    RegisterSpellAndAuraScriptPair(spell_sindragosa_ice_tomb, spell_sindragosa_ice_tomb_aura);
