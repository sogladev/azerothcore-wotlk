...
class spell_rotface_little_ooze_combine : public SpellScript
{
    ...
    {
        return ValidateSpellInfo({ SPELL_OOZE_MERGE });
    }
...
class spell_rotface_large_ooze_combine : public SpellScript
{
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({ SPELL_UNSTABLE_OOZE, 69844, SPELL_UNSTABLE_OOZE_EXPLOSION });
    }
...
class spell_rotface_large_ooze_buff_combine : public SpellScript
{
    ...
    bool Validate(SpellInfo const* /*spellInfo*/) override
    {
        return ValidateSpellInfo({ 69844, SPELL_UNSTABLE_OOZE_EXPLOSION });
    }
