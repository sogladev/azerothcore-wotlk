            ...
            switch (action)
            {
                case ACTION_MARK_OF_THE_FALLEN_CHAMPION:
                    if (Unit* target = SelectTarget(
                            SelectTargetMethod::Random, 1, 0.0f, true, true, -SPELL_MARK_OF_THE_FALLEN_CHAMPION))
                    {
        ...
        void DoAction(int32 action) override
        {
            switch (action)
            {
                case ACTION_START_EVENT:
                {
                    ...
                    Creature* deathbringer =
                        ObjectAccessor::GetCreature(*me, _instance->GetGuidData(DATA_DEATHBRINGER_SAURFANG));
                    ...
                    if (GameObject* teleporter =
                            ObjectAccessor::GetGameObject(*me, _instance->GetGuidData(GO_SCOURGE_TRANSPORTER_SAURFANG)))
                    {
                    ...
                    deathbringer->GetMotionMaster()->MovePoint(POINT_SAURFANG,
...
public:
    ...
    struct npc_saurfang_eventAI : public ScriptedAI
    {
        ...
        void DoAction(int32 action) override
        {
            ...
            {
                me->SetWalk(false);
                me->GetMotionMaster()->MoveCharge(chargePos[_index].GetPositionX(),
...
class spell_deathbringer_blood_link_aura : public AuraScript
{
    ...
    void HandlePeriodicTick(AuraEffect const* /*aurEff*/)
    {
        ...
        if (GetUnitOwner()->getPowerType() == POWER_ENERGY &&
            GetUnitOwner()->GetPower(POWER_ENERGY) == GetUnitOwner()->GetMaxPower(POWER_ENERGY))
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        ...
        return eventInfo.GetActor() && eventInfo.GetActionTarget() &&
               ((damageInfo && damageInfo->GetDamage()) || eventInfo.GetHitMask() & PROC_EX_ABSORB) && procSpell &&
               procSpell->SpellIconID != 2731; // Xinef: Mark of the Fallen Champion
    }
    ...
    void Register() override
    {
        ...
        OnEffectProc +=
            AuraEffectProcFn(spell_deathbringer_blood_link_aura::HandleProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
...
class spell_deathbringer_blood_link_blood_beast_aura : public AuraScript
{
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        ...
        SpellInfo const* procSpell = eventInfo.GetSpellInfo();
        return eventInfo.GetActor() && eventInfo.GetActionTarget() &&
               ((damageInfo && damageInfo->GetDamage()) || eventInfo.GetHitMask() & PROC_EX_ABSORB) &&
               (!procSpell || procSpell->SpellIconID != 2731); // Xinef: Mark of the Fallen Champion
    }
    ...
    void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& eventInfo)
    {
        ...
        */
        ...
        eventInfo.GetActor()->CastCustomSpell(
            SPELL_BLOOD_LINK_DUMMY, SPELLVALUE_BASE_POINT0, basepoints, eventInfo.GetActionTarget(), true);
        return;
    }
    ...
    void Register() override
    {
        ...
        OnEffectProc += AuraEffectProcFn(
            spell_deathbringer_blood_link_blood_beast_aura::HandleProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};
...
class spell_deathbringer_blood_link : public SpellScript
{
    ...
    void HandleDummy(SpellEffIndex /*effIndex*/)
    {
        GetHitUnit()->CastCustomSpell(
            SPELL_BLOOD_LINK_POWER, SPELLVALUE_BASE_POINT0, GetEffectValue(), GetHitUnit(), true);
...
class spell_deathbringer_blood_power_aura : public AuraScript
{
    ...
    void Register() override
    {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_deathbringer_blood_power_aura::RecalculateHook, EFFECT_0, SPELL_AURA_MOD_SCALE);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(
            spell_deathbringer_blood_power_aura::RecalculateHook, EFFECT_1, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE);
    }
};
...
class spell_deathbringer_blood_nova_targeting : public SpellScript
{
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_deathbringer_blood_nova_targeting::FilterTargetsInitial, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_deathbringer_blood_nova_targeting::FilterTargetsSubsequent, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
    }
...
class spell_deathbringer_boiling_blood : public SpellScript
{
    ...
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(
            spell_deathbringer_boiling_blood::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
    }
};
