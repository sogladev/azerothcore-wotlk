...
class spell_aura_of_despair_aura : public AuraScript
{
    ...
    {
        return ValidateSpellInfo({ SPELL_AURA_OF_DESPAIR_2, SPELL_CORRUPTED_RAGE, SPELL_CORRUPTED_WISDOM, SPELL_DRUID_CLEARCASTING, SPELL_MAGE_CLEARCASTING, SPELL_SHAMAN_CLEARCASTING });
    }
    ...
    void OnApply(AuraEffect const*  /*aurEff*/, AuraEffectHandleModes  /*mode*/)
    {
        if (Unit* caster = GetCaster())
            if (Unit* target = GetTarget())
            {
                ...
                target->ApplySpellImmune(SPELL_AURA_OF_DESPAIR_2, IMMUNITY_ID, SPELL_MAGE_CLEARCASTING, true);
                target->ApplySpellImmune(SPELL_AURA_OF_DESPAIR_2, IMMUNITY_ID, SPELL_SHAMAN_CLEARCASTING, true);
    ...
    void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        if (Unit* target = GetTarget())
        {
            ...
            target->ApplySpellImmune(SPELL_AURA_OF_DESPAIR_2, IMMUNITY_ID, SPELL_MAGE_CLEARCASTING, false);
            target->ApplySpellImmune(SPELL_AURA_OF_DESPAIR_2, IMMUNITY_ID, SPELL_SHAMAN_CLEARCASTING, false);
        }
    }
