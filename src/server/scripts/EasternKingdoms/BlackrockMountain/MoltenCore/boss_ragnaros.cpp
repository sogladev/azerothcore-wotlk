...
enum Spells
{
    ...
    SPELL_LAVA_BURST =
        21908, // Randomly trigger one of server side spells (21886, 21900 - 21907) which summons Go 178088
                        ...
                        case EVENT_LAVA_BURST_TRIGGER:
                        {
                            if (!_lavaBurstGUIDS.empty())
                            {
                                ObjectGuid lavaBurstGUID =
                                    Acore::Containers::SelectRandomContainerElement(_lavaBurstGUIDS);
...
constexpr std::array<uint32, 8> RagnarosSoFSpells = {SPELL_SUMMON_SON_OF_FLAME_A,
