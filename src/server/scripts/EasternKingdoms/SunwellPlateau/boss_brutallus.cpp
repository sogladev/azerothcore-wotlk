...
struct boss_brutallus : public BossAI
{
    ...
    void JustEngagedWith(Unit* who) override
    {
        ...
        ScheduleTimedEvent(11s, [&] { DoCastVictim(SPELL_METEOR_SLASH); }, 10s);
        ...
        switch (events.ExecuteEvent())
        {
            ...
            case EVENT_MAD_14:
                if (Creature* brutallus = instance->GetCreature(DATA_BRUTALLUS))
                {
                    ...
                    brutallus->GetMotionMaster()->MovePoint(0,
...
class spell_madrigosa_activate_barrier : public SpellScript
{
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_madrigosa_activate_barrier::HandleActivateObject, EFFECT_0, SPELL_EFFECT_ACTIVATE_OBJECT);
    }
};
...
class spell_madrigosa_deactivate_barrier : public SpellScript
{
    ...
    {
        OnEffectHitTarget += SpellEffectFn(
            spell_madrigosa_deactivate_barrier::HandleActivateObject, EFFECT_0, SPELL_EFFECT_ACTIVATE_OBJECT);
    }
};
...
class spell_brutallus_burn : public SpellScript
{
    ...
    {
        OnEffectHitTarget +=
            SpellEffectFn(spell_brutallus_burn::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};
