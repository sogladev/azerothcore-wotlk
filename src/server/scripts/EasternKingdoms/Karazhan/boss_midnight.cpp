...
struct boss_attumen : public BossAI
{
    ...
    {
        return me->GetVictim() &&
               (me->GetVictim()->GetPositionZ() < 53.0f || me->GetVictim()->GetDistance(me->GetHomePosition()) < 50.0f);
    }
...
class spell_midnight_fixate : public AuraScript
{
    ...
    void Register() override
    {
        OnEffectApply += AuraEffectApplyFn(
            spell_midnight_fixate::HandleEffectApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        OnEffectRemove += AuraEffectRemoveFn(
            spell_midnight_fixate::HandleEffectRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    }
};
