...
void HandleBothDead(Creature* creature, bool jarien, Unit* killer)
{
    ...
    else if (Creature* spirit = creature->FindNearestCreature(NPC_SPIRIT_OF_SOTHOS, 100.f))
    {
        spirit->AttackStop();
        spirit->SetReactState(REACT_PASSIVE);
        spirit->AI()->Talk(SAY_SPIRIT_BOTH_DEAD);
    ...
    // chest spawn
    if (GameObject* chest = killer->SummonGameObject(GO_JARIEN_AND_SOTHOS_HEIRLOOMS,
...
struct boss_jarien : public BossAI
{
    ...
    void IsSummonedBy(WorldObject* /*summoner*/) override
    {
        ...
        _scheduler.Schedule(6s, [this](TaskContext /*context*/) { Talk(SAY_JARIEN_ON_SUMMON_1); })
            .Schedule(12s,
...
struct boss_sothos : public BossAI
{
    ...
    void IsSummonedBy(WorldObject* /*summoner*/) override
    {
        ...
        }).Schedule(9s, [this](TaskContext /*context*/) { Talk(SAY_SOTHOS_ON_SUMMON_1); });
    }
