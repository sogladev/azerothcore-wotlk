    ...
    struct npc_highlord_darion_mograineAI : public ScriptedAI
    {
                ...
                for (Map::PlayerList::const_iterator itr = players.begin(); itr != players.end(); ++itr)
                    if (Player* player = itr->GetSource())
                        if (player->GetPhaseMask() &
                            128) // Xinef: client skips players without chapter 5 aura anyway, speedup
                ...
                if (Unit* target = cr->SelectNearbyTarget(nullptr, 10.0f))
                    if (target->IsCreature())
                        target->GetMotionMaster()->MoveCharge(
                            pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ(), me->GetSpeed(MOVE_RUN));
                cr->GetMotionMaster()->MoveCharge(
                    pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ(), me->GetSpeed(MOVE_RUN));
            }
        ...
        void SummonedCreatureDies(Creature* creature, Unit*) override
        {
            ...
            me->m_Events.AddEvent(
                new DelayedSummonEvent(me, creature->GetEntry(), *creature), me->m_Events.CalculateTime(3000));
        ...
        void FinishFight()
        {
            if (Creature* tirion = me->SummonCreature(
                    NPC_HIGHLORD_TIRION_FORDRING, LightOfDawnPos[6], TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 600000))
            {
                ...
                tirion->SummonGameObject(
                    GO_HOLY_LIGHTNING, 2254.84f, -5298.75f, 82.168f, 1.134f, 0, 0, 0.537102f, 0.843517f, 20);
                tirion->SummonGameObject(
                    GO_HOLY_LIGHTNING, 2296.24f, -5296.44f, 81.9964f, 5.3398f, 0, 0, 0.454395f, -0.8908f, 20);
                tirion->SummonGameObject(
                    GO_HOLY_LIGHTNING, 2314.29f, -5261.78f, 83.1349f, 3.05822f, 0, 0, 0.999131f, 0.0416735f, 20);
                tirion->SummonGameObject(
                    GO_HOLY_LIGHTNING, 2278.43f, -5270.14f, 81.7247f, 0.70988f, 0, 0, 0.347534f, 0.937667f, 20);
            }
        }
            ...
            switch (eventId)
            {
                ...
                case EVENT_START_COUNTDOWN_13:
                {
                    ...
                    for (SummonList::const_iterator itr = summons.begin(); itr != summons.end(); ++itr)
                    {
                        if (Creature* summon = ObjectAccessor::GetCreature(*me, *itr))
                        {
                            ...
                            summon->GetMotionMaster()->MovePoint(
                                1, pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ(), true, false);
                        }
                        first = first == 0 ? 1 : 0;
                    }
                    Position pos = LightOfDawnPos[first];
                    ...
                    me->GetMotionMaster()->MovePoint(
                        1, pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ(), true, true);
                ...
                case EVENT_FINISH_FIGHT_2:
                {
                    ...
                    me->SummonCreature(
                        NPC_DEFENDER_OF_THE_LIGHT, 2276.66f, -5273.60f, 81.86f, 5.14f, TEMPSUMMON_CORPSE_DESPAWN);
                    me->SummonCreature(
                        NPC_DEFENDER_OF_THE_LIGHT, 2272.11f, -5279.08f, 82.01f, 5.69f, TEMPSUMMON_CORPSE_DESPAWN);
                    me->SummonCreature(
                        NPC_DEFENDER_OF_THE_LIGHT, 2285.11f, -5276.73f, 82.08f, 4.23f, TEMPSUMMON_CORPSE_DESPAWN);
                    me->SummonCreature(
                        NPC_DEFENDER_OF_THE_LIGHT, 2290.06f, -5286.41f, 82.51f, 3.16f, TEMPSUMMON_CORPSE_DESPAWN);
                    break;
                }
                case EVENT_FINISH_FIGHT_3:
                    if (Creature* koltira = GetEntryFromSummons(NPC_KOLTIRA_DEATHWEAVER))
                    {
                        ...
                        koltira->GetMotionMaster()->MoveCharge(LightOfDawnPos[3].GetPositionX(),
                ...
                case EVENT_FINISH_FIGHT_4:
                    if (Creature* thassarin = GetEntryFromSummons(NPC_THASSARIAN))
                    {
                        ...
                        thassarin->GetMotionMaster()->MoveCharge(LightOfDawnPos[4].GetPositionX(),
                ...
                case EVENT_FINISH_FIGHT_5:
                    ...
                    me->GetMotionMaster()->MoveCharge(LightOfDawnPos[5].GetPositionX(),
                ...
                case EVENT_OUTRO_SCENE_6:
                    if (Creature* alex = me->SummonCreature(NPC_HIGHLORD_ALEXANDROS_MOGRAINE,
                            ...
                            300000))
                    {
                        ...
                        alex->GetMotionMaster()->MovePoint(0,
                ...
                case EVENT_OUTRO_SCENE_10:
                    if (Creature* darion = me->SummonCreature(NPC_DARION_MOGRAINE,
                ...
                case EVENT_OUTRO_SCENE_11:
                    if (Creature* darion = GetEntryFromSummons(NPC_DARION_MOGRAINE))
                    {
                        ...
                        darion->GetMotionMaster()->MovePoint(0,
                ...
                case EVENT_OUTRO_SCENE_16:
                    ...
                    if (Creature* tirion = GetEntryFromSummons(NPC_HIGHLORD_TIRION_FORDRING))
                        tirion->GetMotionMaster()->MovePoint(0,
                ...
                case EVENT_OUTRO_SCENE_20:
                    if (Creature* lk = me->SummonCreature(NPC_THE_LICH_KING,
                ...
                case EVENT_OUTRO_SCENE_25:
                    if (Creature* lk = GetEntryFromSummons(NPC_THE_LICH_KING))
                        lk->GetMotionMaster()->MovePoint(0,
                        ...
                        for (SummonList::const_iterator itr = summons.begin(); itr != summons.end(); ++itr)
                            if (Creature* summon = ObjectAccessor::GetCreature(*me, *itr))
                                    ...
                                    summon->GetEntry() != NPC_HIGHLORD_TIRION_FORDRING)
                                {
                                    ...
                                    summon->GetMotionMaster()->MovePoint(3,
                ...
                case EVENT_OUTRO_SCENE_47:
                    ...
                    if (Creature* tirion = GetEntryFromSummons(NPC_HIGHLORD_TIRION_FORDRING))
                    {
                        ...
                        tirion->GetMotionMaster()->MovePoint(4,
...
class spell_chapter5_light_of_dawn_aura : public AuraScript
{
    ...
    void Register() override
    {
        OnEffectApply += AuraEffectApplyFn(
            spell_chapter5_light_of_dawn_aura::OnApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        OnEffectRemove += AuraEffectRemoveFn(
            spell_chapter5_light_of_dawn_aura::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    }
};
