...
-- Replace waypoint_data for XT-002 pre-combat patrol path (ported from TC)
-- Verified against 10M sniff
-- This defines a 13-point patrol around the scrap pile area.
-- Waypoint actions reference waypoint_scripts id 2 (points 3,9) and id 5 (point 13)
-- for work emotes (emote 468 = EMOTE_WORK, emote 10 = EMOTE_STATE_WORK).
...
(1360540,  3, 872.6903,  39.44819,  409.8355,        0, 11000, 0, 1360543, 100, 0), -- MovementInform: emote 468
...
(1360540,  9, 876.4196, -77.23026,  409.9155,        0, 11000, 0, 1360549, 100, 0), -- MovementInform: emote 468
...
(1360540, 13, 883.6281, -12.63596,  409.799,  3.159046, 30000, 0, 1360513, 100, 0); -- MovementInform: emote 10

-- Remove old waypoint_scripts (deprecated in AC; handled via MovementInform in C++)

-- Update script names for adds to match new TC-style naming
...
-- Achievement script names: old AC names -> new TC-style names
